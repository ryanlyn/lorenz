...
addition to that budget. Two timers guard each turn: a hard turn timeout (`turn_timeout_ms`, default
3600000) and a stall timeout (`stall_timeout_ms`, default 300000) reset on every agent event. Either
firing cancels the turn.
