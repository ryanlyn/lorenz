...
describe("INVARIANT: When multiple valid labels are present, the system SHALL use the first encountered", () => {
...
describe("INVARIANT: When a label specifies zero or a negative integer, the system SHALL ignore it", () => {
...
describe("INVARIANT: When matching ensemble labels, matching SHALL be case-insensitive and whitespace-insensitive", () => {
...
describe("INVARIANT: When no valid ensemble label is present, the system SHALL return null", () => {
...
describe("INVARIANT: When ensembleSize returns a value, it SHALL be a positive integer (never NaN, Infinity, fractional, or negative)", () => {
