...
import { acquireAgentMcpEndpoint, type AgentMcpEndpointLease } from "../mcp/agentMcpEndpoint.js";
...
function acpProtocolKind(type: string): string {
...
function acpAgentConfig(settings: Settings, kind: string): AcpAgentConfig {
